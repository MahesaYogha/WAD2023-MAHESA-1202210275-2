...
$beratbadan = isset($_POST['berat_badan']) ? $_POST['berat_badan']:"";
$tinggibadan = isset($_POST['tinggi_badan']) ? $_POST['tinggi_badan']:""; 
...
if (empty($tinggibadan)){
    ...
    $Error = "berat dan tinggi badan tidak boleh kosong";
...
// **********************  3  ************************** 
if(empty($Error)){
    $TBLogic= $tinggibadan/100;
    $hitungbmi= $beratbadan/($TBLogic*$TBLogic);
    $hitungbmi = number_format($hitungbmi, 1);
    if ($hitung <= 18.4 ){
        $status = "Underweight";
       }
       elseif($hitung >= 18.5 && $hitung<=24.9 ){
        $status = 'Normal';
       }
       elseif($hitung >=25 && $hitung <= 39.9 ){
        $status = 'overweight';
       }
       elseif($hitung >= 40){
        $status = "Obese";
